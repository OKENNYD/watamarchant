    ...
    return (
      <main className="max-sm:p-6 w-full pb-48 pt-20 h-full flex items-center justify-center">
        <div className="w-[30%] bg-white rounded-2xl max-sm:w-full h-auto py-6 px-6">
          ...
          <p className=" text-base font-normal break-words text-gray-400 text-wrap">Enter the email of the account to be recovered below.</p>
        <form method="post" onSubmit={verify} action={getEmail} className=" max-sm:px-2 flex flex-col gap-4 mt-2 ">
